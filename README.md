...
![ShiYiBao Logo](app/public/logo.png)
...
```text
┌───────────────────────────────────────────────┬───────────────────────────────────────┐
│ 🎬 16:9 原画视频制作与交互控制台             │ 📝 独立白底字幕与 AI 学习对话卡片     │
│ ├─ 实时流式秒开播放器                         │ ├─ 标签 1: 双语字幕列表 (实时滑动跟随) │
│ ├─ V1/S1/A1/A2 极速音视频多轨时间轴            │ ├─ 标签 2: AI 核心摘要与结构化学习大纲│
│ └─ 180 根 SVG 动态声纹预渲染波形图            │ └─ 标签 3: 交互式 AI 问答助教对话流   │
└───────────────────────────────────────────────┴───────────────────────────────────────┘
```
